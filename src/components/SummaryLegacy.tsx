    ...
    <div className="max-w-[1400px] mx-auto animate-fadeIn">
      ...
      <section className="flex flex-col h-[calc(100vh-180px)] min-h-[600px] bg-surface-light dark:bg-surface-dark rounded-2xl shadow-sm border border-gray-100 dark:border-gray-700 overflow-hidden">
        ...
        <div className="flex-1 flex overflow-hidden">
          <div className="flex-1 overflow-y-auto p-6 md:p-8 pr-4">
            <article className="prose prose-slate dark:prose-invert max-w-none">
              <p className="text-lg leading-relaxed text-secondary dark:text-gray-200 mb-6">
                In this meeting, the team discussed{' '}
                <span className="bg-blue-100 dark:bg-blue-900/40 px-1 py-0.5 rounded text-blue-800 dark:text-blue-200 font-medium">
                  Marketing Strategy for Q4
                </span>
                , focusing on preparing for the new product launch at the end of the year, which is a key period for generating sales.
              </p>
              <p className="text-lg leading-relaxed text-secondary dark:text-gray-200 mb-6">
                A key point raised was regarding the{' '}
                <span className="bg-yellow-100 dark:bg-yellow-900/40 px-1 py-0.5 rounded text-yellow-800 dark:text-yellow-200 font-medium">
                  Advertising Budget
                </span>
                . The finance department proposed reducing the budget for print media and reallocating it to online media and social media.
              </p>
              <p className="text-lg leading-relaxed text-secondary dark:text-gray-200 mb-6">
                Additionally, the development team updated the progress of{' '}
                <span className="bg-green-100 dark:bg-green-900/40 px-1 py-0.5 rounded text-green-800 dark:text-green-200 font-medium">
                  Project Alpha
                </span>
                , stating that it is currently in final system testing and is expected to be ready for a soft launch in the next 2 weeks.
              </p>
              <p className="text-lg leading-relaxed text-secondary dark:text-gray-200 mb-6">
                Finally, the meeting summarized the operational plan for next week, assigning the marketing department to accelerate{' '}
                <span className="bg-purple-100 dark:bg-purple-900/40 px-1 py-0.5 rounded text-purple-800 dark:text-purple-200 font-medium">
                  Promotion Campaigns
                </span>
                with partners to build momentum before the actual product launch.
              </p>
              <p className="text-lg leading-relaxed text-secondary dark:text-gray-200 mb-6">
        ...
        <div className="p-5 md:p-6 border-t border-gray-100 dark:border-gray-700 bg-white dark:bg-surface-dark flex justify-end gap-3">
          <button className="px-5 py-2.5 rounded-xl border border-gray-300 dark:border-gray-600 text-secondary dark:text-gray-200 font-medium hover:bg-gray-50 dark:hover:bg-gray-700 transition-colors flex items-center">
            <span className="material-icons-round mr-2 text-sm">edit</span>
            Edit Text
          </button>
          ...
          {recentWork.map((item) => (
            ...
            >
              <div className="flex justify-between items-start mb-3">
                <div
                  className={`w-10 h-10 rounded-xl flex items-center justify-center group-hover:scale-110 transition-transform duration-200 ${item.iconClass}`}
                >
              ...
              <p className="text-sm text-slate-500 dark:text-slate-400 line-clamp-2 mb-4 leading-relaxed">{item.desc}</p>
